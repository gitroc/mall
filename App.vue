<script>
    ...
    import config from './config/emerald/config.js';
    import util from './config/emerald/util.js';
    import {
        mapActions
    } from 'vuex'
    ...
    export default {
        ...
        async mounted() {
            if (this.$store.getters.isLogin && !this.$Cache.get('USER_INFO')) await this.$store.dispatch(
            'USERINFO');
        },
        methods: {},
        onShow: function() {
...
<style>
    ...
    @import url("pages_emerald/static/css/bookchat.css");
