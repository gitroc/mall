 ...
 * 
*/
export function getAuctionIndexTime(){
  return request.get('auction/index',{},{noAuth:true});
}
 ...
 * @param object data
*/
export function getAuctionList(time,data){
  return request.get('auction/list/'+time,data,{noAuth:true});
}
 ...
 * 获取秒杀小程序二维码
 */
export function auctionCode(id,data) {
  return request.get("auction/code/"+id,data);
}
 ...
 * @param int id
*/
export function getAuctionHeaderApi(){
  return request.get('auction/header',{},{noAuth:true});
}

/**
 * 首页竞拍产品列表
*/
export function getAuctionIndexApi(){
  return request.get('auction/index',{},{noAuth:true});
}
