<template>
    <view class="pay-page">
        ...
        <view class="pay-content">
                ...
                <view class="list-content">
                    ...
                    <view class="text-box">
                        ...
                        <view class="total-price-box">
                            <view class="label font-sty03">订单总价：</view>
                            <view class="price font-sty03">￥{{item.realPrice}}</view>
                        </view>
                    </view>
                </view>
            </view>
            <view class="pay-box">
                ...
                <view class="bank-box">
                    <view class="item">
                        ...
                        <view class="input-box">
                            <view class="uni-list-cell-db">
                                <view class="uni-input">{{item.realPrice}}</view>
                            </view>
                    ...
                    <view class="item">
                        ...
                        <view class="input-box">
                            <view class="uni-list-cell-db">
                                <view class="uni-input">{{item.orderTime}}</view>
                            </view>
                            <image class="card" mode="widthFix" src="../../static/images/card.png"></image>
                        </view>
                    </view>
                    <view class="item">
                        <view class="label">买家手机</view>
                        <view class="input-box">
                            <view class="uni-list-cell-db">
                                <view class="uni-input">{{item.buyerMobile}}</view>
                            </view>
                            <image class="card" mode="widthFix" src="../../static/images/card.png"></image>
                        </view>
                    </view>
                    <view class="item">
                        <view class="label">买家姓名</view>
                        <view class="input-box">
                            <view class="uni-list-cell-db">
                                <view class="uni-input">{{item.buyerName}}</view>
                            </view>
                            <image class="card" mode="widthFix" src="../../static/images/card.png"></image>
                        </view>
                    </view>
            ...
            <view class="btn" @click="confirmDeal()">确认收款</view>
        </view>
    </view>
</template>
...
export default {
        ...
        methods: {
            ...
            getItem(item) {
                ...
                that.item.buyerName = item.buyerName
